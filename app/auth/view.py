...
from .. import db
from . import auth
from .form import LoginForm, RegistrationForm, ResetPasswordForm, ChangeEmailForm, ChangePasswordForm, \
...
def change_email(token):
    if current_user.change_email(token):
        ...
        flash('The confirmation link is invalid or has expired or email address has already exist')
    return redirect(url_for('main.index'))
